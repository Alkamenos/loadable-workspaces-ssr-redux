...
class Player extends PhysicalObject {
  ...
  private animateRunningInterval: number |  undefined;
  ...
  private animateJumpInterval: number |  undefined;
  ...
  destroy() {
    clearInterval(this.animateRunningInterval as number);
    clearInterval(this.animateJumpInterval as number);
